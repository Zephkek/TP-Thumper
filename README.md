...
### Overview
Critical memory corruption vulnerability discovered in TP-Link VN020 routers (FVT firmware version TT_V6.2.1021) through malformed DHCP DISCOVER packets. Affects all TP-Link VN020-F3v(T) routers deployed by Tunisie Telecom.
